...
- 默认模型：DeepSeek 4.1 Flash（4.1f），官方 API ID 为 `deepseek-flash`。
...
- 模型和 API Key 区域默认折叠，由门户统一管理。浏览器无需输入密钥，仅请求 `https://cnt-vision.47.236.76.214.nip.io/api/chat`；密钥由阿里云服务器受限文件读取，不下发浏览器、不进入 GitHub 或 Pages 文件。
...
模型及图像请求格式依据：[DeepSeek 模型说明](https://api-docs.deepseek.com/quick_start/pricing/)、[图像理解](https://api-docs.deepseek.com/guides/vision/)（2026-09-11 核验）。
